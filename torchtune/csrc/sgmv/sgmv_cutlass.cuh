...
bool sgmv(DType *y, DType *x, DType **w, int32_t *s, void *tmp_d,
    ...
    using GemmKernel = typename cutlass::gemm::kernel::DefaultGemmGrouped<
        ...
        cutlass::ComplexTransform::kNone,               // Transform A
        8,                                              // Alignment A
        cutlass_t,                                      // Element B
        cutlass::layout::RowMajor,                      // Layout B
        cutlass::ComplexTransform::kNone,               // Transform B
        8,                                              // Alignment B
        cutlass_t,                                      // Element C
        ...
        cutlass::gemm::GemmShape<128, 128, 16>,         // Threadblock Shape
        cutlass::gemm::GemmShape<64, 64, 16>,           // Warp Shape
        cutlass::gemm::GemmShape<16, 8, 8>,             // Instruction Shape
        cutlass::epilogue::thread::LinearCombination<   // Epilogue Output Op
            cutlass_t,                                  // Element Output
            1,                                          // Elements/Access
            float,                                      // Accumulator
            float>,                                     // Scalar
