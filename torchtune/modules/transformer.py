...
from torchtune.modules import CausalSelfAttention, KVCache, ConcurrentCausalSelfAttention
...
class ConcurrentTransformerDecoderLayer(nn.Module):
    """Transformer layer derived from the Llama2 model. Normalization is applied before the attention **and** FF layer.
    ...
    def __init__(
        self,
        attn: ConcurrentCausalSelfAttention,
        mlp: nn.Module,
        sa_norm: nn.Module,
        mlp_norm: nn.Module,
    ) -> None:
