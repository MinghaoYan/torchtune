...
from torchtune.models.llama3._component_builders import llama3, lora_llama3, async_lora_llama3
...
def llama3_70b() -> TransformerDecoder:
    ...
    return llama3(
        ...
        num_kv_heads=8,
        embed_dim=8192,
        max_seq_len=131072, #llama3 is 8192
